...
@section('titulo', 'Registrar nueva llanta')

@section('contenido')
<form action="{{ url('/llanta') }}" method="post">
    @csrf
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="medida">Medida</label>
            <input id="medida" class="form-control" type="text" name="medida" value="{{old('medida')}}">
            @error('medida')
            <small>*{{$message}}</small>
            <br>
            @enderror
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="number" class="form-control" id="mspn" name="mspn" value="{{old('mspn')}}">
            @error('mspn')
            <small>*{{$message}}</small>
            <br>
            @enderror
        ...
        <div class="form-group col-md-8">
            ...
            <input type="text" class="form-control" id="gama" name="gama" value="{{old('gama')}}">
            @error('gama')
            <small>*{{$message}}</small>
            <br>
            @enderror
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input id="ic_rv" class="form-control" type="text" name="ic_rv" value="{{old('ic_rv')}}">
            @error('ic_rv')
            <small>*{{$message}}</small>
            <br>
            @enderror
        ...
        <div class="form-group col-md-4">
            ...
            <input id="tecnologia" class="form-control" type="text" name="tecnologia" value="{{old('tecnologia')}}">
            @error('tecnologia')
            <small>*{{$message}}</small>
            <br>
            @enderror
        ...
        <div class="form-group col-md-4">
            ...
            <input id="marcaje_oe" class="form-control" type="text" name="marcaje_oe" value="{{old('marcaje_oe')}}">
            @error('marcaje_oe')
            <small>*{{$message}}</small>
            <br>
            @enderror
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input id="vehiculo_equi_orig" class="form-control" type="text" name="vehiculo_equi_orig" value="{{old('vehiculo_equi_orig')}}">
